...
const WeAre = () => {
  ...
  const renderButton = numberOfParagraphs !== weAreParagraphs.length;
  ...
  return (
    <SectionContainer section={SECTIONS.WE_ARE}>
      ...
      {renderButton && (
        <Button text="Leer más" bgColor="myWhite-500" textColor="myPurple-100" onClick={() => setNumberOfParagraphs(weAreParagraphs.length)} Icon={MdExpandMore} className="mb-6" />)  
      }
